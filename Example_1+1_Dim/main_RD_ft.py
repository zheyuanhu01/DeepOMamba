...
# f_train_all, f_test_all, y_train_all, y_test_all = [], [], [], []

# for i in range(1, 6):
#     reader = MatReader('RD_' + str(i) + '.mat')
...
#     f_train_all.append(f_train)
#     f_test_all.append(f_test)
#     y_train_all.append(y_train)
#     y_test_all.append(y_test)

# f_train = np.concatenate(f_train_all, 0)
# f_test = np.concatenate(f_test_all, 0)
# y_train = np.concatenate(y_train_all, 0)
# y_test = np.concatenate(y_test_all, 0)

reader = MatReader('RD_ft_k0.01_D0.01.mat')
f_train = reader.read_field('F_train').numpy()
y_train = reader.read_field('U_train').numpy()
f_test = reader.read_field('F_test').numpy()
y_test = reader.read_field('U_test').numpy()
